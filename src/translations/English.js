...
export const ENGLISH_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'I want to send these ZCL',
    ...
    notEnoughZCL: 'Not enough confirmed ZCL in account to perform transaction.',
  ...
  PinPage: {
    ...
    verifyPinPageTitle: 'ZCL Wallet PIN Verification',
