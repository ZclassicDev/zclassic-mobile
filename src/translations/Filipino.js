...
export const FILIPINO_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Gusto ko ipadala ang ZCL na ito.',
    ...
    notEnoughZCL: 'Hindi sapat na kumpirmadong ZCL sa account para gawin ang transaksiyon.',
  ...
  PinPage: {
    ...
    newPinPageTitle: 'ZCL Wallet Setup',
    verifyPinPageTitle: 'Pagpapatunay ng ZCL Wallet PIN',
